...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	Route::get(config('laraadmin.adminRoute') . '/detail_tran_dt_ajax', 'LA\Detail_transController@dtajax');

	/* ================== Rekap_trans ================== */
	Route::resource(config('laraadmin.adminRoute') . '/rekap_trans', 'LA\Rekap_transController');
	Route::get(config('laraadmin.adminRoute') . '/rekap_tran_dt_ajax', 'LA\Rekap_transController@dtajax');
});
