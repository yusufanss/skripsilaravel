...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $kategori->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-3">
			...
			<div class="dats1"><i class="fa fa-map-marker"></i> Bandung</div>
		</div>
		<div class="col-md-4">
			<!--
			<div class="teamview">
		...
		<div class="col-md-1 actions">
			@la_access("Kategoris", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/kategoris/'.$kategori->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Kategoris", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.kategoris.destroy', $kategori->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/kategoris') }}" data-toggle="tooltip" data-placement="right" title="Back to Kategoris"><i class="fa fa-chevron-left"></i></a></li>
		...
		<div role="tabpanel" class="tab-pane active fade in" id="tab-info">
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="form-group"><label for="nama_kategori" class="col-md-2">ID Kategory</label><div class="col-md-10 fvalue">{{ $kategori->id }}</div></div>
					@la_display($module, 'nama_kategori')
					</div>
				</div>
			</div>
		</div>
