...
class CreateTransTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Trans", 'trans', 'no_faktur', 'fa-align-justify', [
            ["no_faktur", "no faktur", "String", true, "", 0, 256, false],
            ["waktu", "tanggal", "Datetime", false, "", 0, 0, false],
            ["total", "total", "Decimal", false, "0", 1, 4294967295, false],
        ]);
